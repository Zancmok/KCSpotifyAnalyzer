...
def login() -> ResponseReturnValue:
    ...
    Starts the Spotify authentication flow by redirecting the user to the
    authorization URL generated by the OAuth manager.
    """
...
def callback() -> ResponseReturnValue:
    ...
    Spotify profile information, creates or updates the local user record, and
    stores the user's Spotify ID in the session.
    """
    if (code := request.args.to_dict().get('code')) is None:
        print("Code missing!", flush=True)
